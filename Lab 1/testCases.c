...
//=================Question 2================================
    ...
    void TestQ2_decimal1(CuTest *tc) {
    ...
    void TestQ2_decimal2(CuTest *tc) {
    ...
    void TestQ2_fraction(CuTest *tc) {
...
//=================Question 4================================ 
    ...
    void TestQ4_decimal1(CuTest *tc) {
    ...
    void TestQ4_decimal2(CuTest *tc) {

        		int input = 15.75;
        double actual = Q4(input);
        double expected = 3.208186;
        CuAssertDblEquals(tc, expected, actual,0.0000009);
            }
//===========================================================
//=================Question 5================================ 
...
//=================Question 6================================   
    ...
    void TestQ6_bordertest(CuTest *tc) {
         int input = 28;
         int expected[100]={0},actual[100]={0};
         expected[0]=6;
         expected[1]=28;
    ...
    void TestQ6_fraction(CuTest *tc) {
          int input = (992/2);
          int expected[100]={0},actual[100]={0};
          expected[0]=6;
          expected[1]=28;
...
//=================Question 7================================  
    ...
    void TestQ7a_3(CuTest *tc) {
        int input = -7869125;
        int actual = Q7a(input);
        int expected = 5219687;
            CuAssertIntEquals(tc, expected, actual);
    }
    void TestQ7a_4(CuTest *tc) {
        int input = 1234.567;
        int actual = Q7a(input);
        int expected = 0;
            CuAssertIntEquals(tc, expected, actual);
    }
    void TestQ7a_5(CuTest *tc) {
        int input = (2469134/2);
        int actual = Q7a(input);
    ...
    void TestQ7b_4(CuTest *tc) {
        int input = -4789231;
        int actual = Q7b(input);
        int expected = 1329874;
        CuAssertIntEquals(tc, expected, actual);
    }
    void TestQ7b_5(CuTest *tc) {
        int input = (60952/4);
        int actual = Q7b(input);
        int expected = 83251;
        CuAssertIntEquals(tc, expected, actual);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_decimal1);
        SUITE_ADD_TEST(suite, TestQ2_decimal2);
        SUITE_ADD_TEST(suite, TestQ2_fraction);

        SUITE_ADD_TEST(suite, TestQ3_7);
        ...
        SUITE_ADD_TEST(suite, TestQ4_decimal1);
        SUITE_ADD_TEST(suite, TestQ4_decimal2);
        ...
        SUITE_ADD_TEST(suite, TestQ6_bordertest);
        SUITE_ADD_TEST(suite, TestQ6_decimal);
        SUITE_ADD_TEST(suite, TestQ6_fraction);
        SUITE_ADD_TEST(suite, TestQ6_none);
        ...
        SUITE_ADD_TEST(suite, TestQ7a_4);
        SUITE_ADD_TEST(suite, TestQ7a_5);


        SUITE_ADD_TEST(suite, TestQ7b_1);
        SUITE_ADD_TEST(suite, TestQ7b_2);
        SUITE_ADD_TEST(suite, TestQ7b_3);
        SUITE_ADD_TEST(suite, TestQ7b_4);
        SUITE_ADD_TEST(suite, TestQ7b_5);
