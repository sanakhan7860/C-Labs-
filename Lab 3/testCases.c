...
//=========Question 1==================================
	...
	void TestQ1_number_string(CuTest *tc) {

	    CuAssertStrEquals(tc, "McMaster123", my_strcat("McMaster","123"));
	}

	void TestQ1_symbols(CuTest *tc) {

		CuAssertStrEquals(tc, "Toronto,,,", my_strcat("Toronto",",,,"));
	}
...
//=================Question 2================================
	void TestQ2_find_notThere(CuTest *tc) {
		...
		char inputFile[] =  "lab3-sanakhan7860/students.txt";
		int size;
	...
	void TestQ2_inputGradesAndCalculateFinal(CuTest *tc) {
		...
		char inputFile[] =  "lab3-sanakhan7860/students.txt";
		char gradesFile[] =  "lab3-sanakhan7860/grades.txt";
		int size;
		//create list using the input file
		student **Clist = create_class_list(inputFile,&size);
		...
		output_final_course_grades("lab3-sanakhan7860/outputGrades.txt",Clist,size);

		//now we open the golden file with the written file and compare line by line

		char actualFile[] =  "lab3-sanakhan7860/outputGrades.txt";
		char goldenFile[] =  "lab3-sanakhan7860/output.txt";
...
*/
	...
	void TestQ2_test_WithdrawExists1(CuTest *tc){

		char input_file[] = "lab3-sanakhan7860/students.txt";
		int size;

		student **Clist = create_class_list(input_file, &size);

		withdraw(7000,Clist,&size);

		int actual = find(7000,Clist,size); //file does not exist
		int expected = -1;
	...
	void TestQ2_test_WithdrawExists2(CuTest *tc){
		...
		withdraw(6547,Clist,&size);

		int actual = find(6547,Clist,size); //file does not exist
		int expected = -1;
	...
	void TestQ2_test_WithdrawNotExist(CuTest *tc){
			...
			withdraw(2314,Clist,&size);

			int actual = find(2314,Clist,size); //file exists
			int expected = -1;
...
//=================Question 3================================  
	void TestQ3_readandSort1(CuTest *tc) {
		...
		char inputFile[] =  "lab3-sanakhan7860/wordlist.txt";
		int size;
		//create list using the input file
...
//===========================================================
	...
	/*	SUITE_ADD_TEST(suite, TestQ1_two_strings);
		...
		SUITE_ADD_TEST(suite, TestQ1_number_string);
		SUITE_ADD_TEST(suite, TestQ1_symbols);
	    ...
	    SUITE_ADD_TEST(suite, TestQ2_test_WithdrawExists1);
	    SUITE_ADD_TEST(suite, TestQ2_test_WithdrawExists2);
        SUITE_ADD_TEST(suite, TestQ2_test_WithdrawNotExist);
*/
